  ...
  return (
    <section id="home" className="relative h-[calc(100vh-4rem)] w-full">
      <Image
        ...
        alt="A diverse group of students in a moment of prayer and revival"
        layout="fill"
        objectFit="cover"
      ...
      <div className="relative z-10 flex h-full flex-col items-start justify-center text-left text-white container mx-auto px-4">
        <div className="space-y-6 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <p 
            className="max-w-2xl text-lg md:text-xl text-primary-foreground/90"
          >
        ...
        >
          ...
          <Button
            ...
            size="lg"
            variant="default"
            className="font-bold text-base bg-accent hover:bg-accent/90 text-accent-foreground shadow-lg"
          >
            <Link href="#donate">
